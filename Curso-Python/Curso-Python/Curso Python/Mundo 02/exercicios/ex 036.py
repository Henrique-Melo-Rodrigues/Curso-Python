...
# prestação mensal:
# Porcentagem da prestação mensal sobre o salário e a quantidade de anos a ser pago
prest = (valor/meses)
...
if prest > minimo:
    print(
        f'Devido a prestação mensal ser de R${prest:.2f} e o seu salário mensal ser {salário:.2f} excede em muito ao seu atual custo de vida...')
    print('Devido a isso, o seu empréstimo foi negado.')
elif prest <= minimo:
    print(
        f'A porcetangem a ser paga da prestação é de R${prest:.2f} e o seu salário mensal é de {salário:.2f}.')
